...
ROLE_DEFINITIONS: dict[AgentRole, RoleDefinition] = {
    AgentRole.PLANNER: RoleDefinition(
        ...
        description=(
            "Plans and coordinates tasks across the swarm, setting priorities and sequencing work."
        ),
    ...
    AgentRole.SUPPORT: RoleDefinition(
        ...
        description=(
            "Handles inbound support tickets, triages issues, and communicates with customers."
        ),
