...
class TestValidate:
    ...
    @patch("autoswarm_workflows.acp_qa_oracle.asyncio")
    def test_validate_passes_when_bash_tool_unavailable(
        ...
        blocker = _block_imports(
            "autoswarm_tools.approval",
            "autoswarm_workers.tools.bash_tool",
        )
    ...
    def test_validate_passes_when_bash_returns_zero(
        ...
        def _import_with_mock_bash(name: str, *args, **kwargs):  # type: ignore[no-untyped-def]
            if name == "autoswarm_tools.approval":
                raise ImportError("mocked")
            if name == "autoswarm_workers.tools.bash_tool":
                mod = MagicMock()
    ...
    def test_validate_passes_with_empty_test_suite(
        ...
        blocker = _block_imports("autoswarm_tools.approval")
