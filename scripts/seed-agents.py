...
AGENT_TEMPLATES = [
    # Engineering (6)
    {"name": "Coder-Alpha", "role": "coder", "level": 2, "department_slug": "engineering",
     "skill_ids": ["coding", "research"]},
    {"name": "Coder-Beta", "role": "coder", "level": 1, "department_slug": "engineering",
     "skill_ids": ["coding", "webapp-testing"]},
    {"name": "Reviewer-Alpha", "role": "reviewer", "level": 2, "department_slug": "engineering",
     "skill_ids": ["code-review", "webapp-testing"]},
    {"name": "Planner-Alpha", "role": "planner", "level": 3, "department_slug": "engineering",
     "skill_ids": ["strategic-planning", "research"]},
    {"name": "Coder-Gamma", "role": "coder", "level": 1, "department_slug": "engineering",
     "skill_ids": ["coding", "doc-coauthoring"]},
    {"name": "Reviewer-Beta", "role": "reviewer", "level": 1, "department_slug": "engineering",
     "skill_ids": ["code-review", "doc-coauthoring"]},
    # Research (3)
    {"name": "Researcher-Alpha", "role": "researcher", "level": 2, "department_slug": "research",
     "skill_ids": ["research", "doc-coauthoring"]},
    {"name": "Researcher-Beta", "role": "researcher", "level": 1, "department_slug": "research",
     "skill_ids": ["research", "strategic-planning"]},
    {"name": "Researcher-Gamma", "role": "researcher", "level": 1, "department_slug": "research",
     "skill_ids": ["research", "coding"]},
    # CRM (2)
    {"name": "CRM-Alpha", "role": "crm", "level": 2, "department_slug": "crm",
     "skill_ids": ["crm-outreach", "research"]},
    {"name": "CRM-Beta", "role": "crm", "level": 1, "department_slug": "crm",
     "skill_ids": ["crm-outreach", "research"]},
    # Support (2)
    {"name": "Support-Alpha", "role": "support", "level": 2, "department_slug": "support",
     "skill_ids": ["customer-support", "research"]},
    {"name": "Support-Beta", "role": "support", "level": 1, "department_slug": "support",
