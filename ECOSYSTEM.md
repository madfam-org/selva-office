...
**Registry product**: Selva (`selva`, live, front door selva.town).
...
# Logs
enclii logs selva-nexus-api --env prod -f                    # live tail
enclii logs selva-nexus-api --env prod --since 1h -n 200     # last hour
...
# Rollback
enclii rollback selva-nexus-api --env prod                   # previous release
enclii rollback selva-nexus-api v42 --env prod

# Releases + deployment history
enclii releases selva-nexus-api -n 20
...
enclii domains list --service selva-nexus-api
enclii domains add my.example.com --service selva-nexus-api   # auto-provisions tunnel route + DNS
